...
//
//--------------------------------------------------------------------------------------------------
define('ROUTES_DIR'      , 'Routes' . DS                              );
define('DATABASES_DIR'   , 'Databases' . DS                           );
define('CONFIG_DIR'      , 'Config' . DS                              );
define('STORAGE_DIR'     , 'Storage'.DS                               );
define('COMMANDS_DIR'    , 'Commands' . DS                            );
define('RESOURCES_DIR'   , 'Resources' . DS                           );
define('STARTING_DIR'    , 'Starting' . DS                            );
define('AUTOLOAD_DIR'    , STARTING_DIR.'Autoload'.DS                 );
define('HANDLOAD_DIR'    , STARTING_DIR.'Handload'.DS                 );
define('LANGUAGES_DIR'   , 'Languages' . DS                           );
define('LIBRARIES_DIR'   , 'Libraries' . DS                           );
define('REQUIREMENTS_DIR', LIBRARIES_DIR.'Requirements'.DS.'System'.DS);
